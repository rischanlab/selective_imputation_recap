...
input_file1 = 'results/sumavg_ideal_impute.csv'
input_file2 = 'results/sumavg_ideal_rand_impute.csv'
input_file3 = 'results/sumavg_dirty_impute.csv'
input_file4 = 'results/sumavg_missing_vs_ideal.csv'
...
ax.set_ylabel("Effectiveness - SUM AVG")
