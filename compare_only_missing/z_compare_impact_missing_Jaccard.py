...
dfjrow200 = dfjrow200['Jaccard']

dfjrow250 = df[(df['k'] == k) & (df['sample'] == 250)]
dfjrow250 = dfjrow250['Jaccard']

dfjrow299 = df[(df['k'] == k) & (df['sample'] == 299)]
dfjrow299 = dfjrow299['Jaccard']
