...
output_plot = 'pbrank_baselines_rbo'



df1 = pd.read_csv('pbrank_rbo/noimpute.csv')
df2 = pd.read_csv('pbrank_rbo/pbrank.csv') 
df3 = pd.read_csv('pbrank_rbo/random.csv')
df4 = pd.read_csv('pbrank_rbo/pbci_fairness.csv')
...
ax.plot(mean4, lw = 1, color = '#0000FF', alpha = 1, label = 'VizPut-Cell-Impact-Fairness', marker='*', linestyle=':', linewidth=2, markersize=20)#b35410 #marker='*', linestyle='-', linewidth=2, markersize=20)
