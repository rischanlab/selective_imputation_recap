...
output_plot = 'pbci_baselines_rbo'



df1 = pd.read_csv('pbci_rbo/noimpute.csv')
df2 = pd.read_csv('pbci_rbo/pbci.csv') #PBCI
df3 = pd.read_csv('pbci_rbo/random.csv')
df4 = pd.read_csv('pbci_rbo/pbci_fairness.csv')
df5 = pd.read_csv('pbci_rbo/fairness.csv')
