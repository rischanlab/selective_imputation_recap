...
input_file1 = 'results/max_ideal_impute.csv'
input_file2 = 'results/max_ideal_rand_impute.csv'
input_file3 = 'results/max_dirty_impute.csv'
...
ax.set_ylabel("Effectiveness - agg MAX")
