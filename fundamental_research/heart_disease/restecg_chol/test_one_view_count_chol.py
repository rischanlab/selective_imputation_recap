...
for i in mlist:
	for j in range(100):
		...
		q1="select restecg, count(*) from df where cp = 'typical_angina' and restecg is not null group by restecg order by restecg;"
		q2="select restecg, count(*) from di1 where cp = 'typical_angina' and restecg is not null group by restecg order by restecg;"
