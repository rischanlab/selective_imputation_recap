...
output_plot = 'pbci_baselines_rbo_extrem'



df1 = pd.read_csv('pbci_rbo_extrem/noimpute.csv')
df2 = pd.read_csv('pbci_rbo_extrem/pbci.csv') #PBCI
df3 = pd.read_csv('pbci_rbo_extrem/random.csv')
df4 = pd.read_csv('pbci_rbo_extrem/pbci_column.csv')
