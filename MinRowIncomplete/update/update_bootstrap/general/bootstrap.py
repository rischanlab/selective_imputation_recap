...
ax.plot(mean1, lw = 1, color = '#539caf', alpha = 1, label = 'RandomCells Imputation', marker='x', linestyle='-.', linewidth=2, markersize=12)
ax.plot(mean2, lw = 1, color = '#b65332', alpha = 1, label = 'Bootstrap + MinRowIncompleteData Imputation', marker='<', linestyle='-', linewidth=2, markersize=12)
