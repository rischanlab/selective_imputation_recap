...
ax.plot(mean1, lw = 1, color = '#fc0330', alpha = 1, label = 'Uniform random selection imputation', marker='+', linestyle='--', linewidth=2, markersize=20)
ax.plot(mean2, lw = 1, color = '#029dd1', alpha = 1, label = 'Stratified selection imputation', marker='<', linestyle='-.', linewidth=2, markersize=20)
ax.plot(mean3, lw = 1, color = '#520ec7', alpha = 1, label = 'Ignore cells no imputation', marker='*', linestyle=':', linewidth=2, markersize=20)
