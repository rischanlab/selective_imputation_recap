...
input_file1 = 'results/sum_ideal_impute.csv'
input_file2 = 'results/sum_ideal_rand_impute.csv'
input_file3 = 'results/sum_dirty_impute.csv'
input_file4 = 'results/sum_missing_vs_ideal.csv'
...
ax.set_ylabel("Effectiveness - agg SUM")
