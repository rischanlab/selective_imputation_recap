...
output_plot = 'heart_disease_a_constant'



df1 = pd.read_csv('heart_disease/noimpute.csv')
df2 = pd.read_csv('heart_disease/pbci.csv') #PBCI
df3 = pd.read_csv('heart_disease/random_imputation.csv')
df4 = pd.read_csv('heart_disease/pbci_fairness.csv')
df5 = pd.read_csv('heart_disease/fairness.csv')
