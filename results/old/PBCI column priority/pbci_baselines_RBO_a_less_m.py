...
output_plot = 'pbci_baselines_rbo_a_less_m'



df1 = pd.read_csv('pbci_rbo_a_less_m/noimpute.csv')
df2 = pd.read_csv('pbci_rbo_a_less_m/pbci.csv') #PBCI
df3 = pd.read_csv('pbci_rbo_a_less_m/random.csv')
df4 = pd.read_csv('pbci_rbo_a_less_m/pbci_column.csv')
...
ax.plot(mean2, lw = 1, color = '#FF0000', alpha = 1, label = 'PBCI (default)', marker='<', linestyle='-.', linewidth=2, markersize=20)
ax.plot(mean4, lw = 1, color = '#0000FF', alpha = 1, label = 'PBCI with fairness', marker='*', linestyle=':', linewidth=2, markersize=20)
ax.plot(mean3, lw = 1, color = '#008000', alpha = 1, label = 'PriorityBasedOnRandomSelection', marker='o', linestyle='--', linewidth=2, markersize=20)
