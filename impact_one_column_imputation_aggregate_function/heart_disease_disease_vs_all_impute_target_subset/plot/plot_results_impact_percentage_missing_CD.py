...
input_file1 = 'results/avg_missing_vs_ideal.csv'
input_file2 = 'results/avg_ideal_impute.csv'
...
ax.plot(mean1, lw = 1, color = '#fc7303', alpha = 1, label = 'AVG - no impute vs ideal', marker='x', linestyle=':', linewidth=2, markersize=20)
ax.plot(mean2, lw = 1, color = '#FF0000', alpha = 1, label = 'AVG - impute target subset', marker='<', linestyle='-.', linewidth=2, markersize=20)
ax.plot(mean3, lw = 1, color = '#008000', alpha = 1, label = 'MAX - no impute vs ideal', marker='o', linestyle='--', linewidth=2, markersize=20)
ax.plot(mean4, lw = 1, color = '#0000FF', alpha = 1, label = 'MAX - impute target subset', marker='+', linestyle=':', linewidth=2, markersize=20)
