...
input_file1 = 'results/avg_chol_distance.csv'
input_file2 = 'results/max_chol_distance.csv'

input_file3 = 'results/sum_chol_distance.csv'
#input_file4 = 'results/avg_chol_distance.csv'




output_plot = 'distance_all_v2'
...
ax.plot(mean1, lw = 1, color = '#fc7303', alpha = 1, label = 'restecg_AVG_chol', marker='x', linestyle=':', linewidth=2, markersize=20)
ax.plot(mean2, lw = 1, color = '#FF0000', alpha = 1, label = 'restecg_MAX_chol', marker='<', linestyle='-.', linewidth=2, markersize=20)
ax.plot(mean3, lw = 1, color = '#008000', alpha = 1, label = 'restecg_SUM_chol', marker='o', linestyle='--', linewidth=2, markersize=20)
