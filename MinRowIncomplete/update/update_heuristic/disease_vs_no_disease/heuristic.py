...
ax.plot(mean1, lw = 1, color = '#539caf', alpha = 1, label = 'RandomCells impute', marker='x', linestyle='-.', linewidth=2, markersize=12)
ax.plot(mean2, lw = 1, color = '#3a14e3', alpha = 1, label = 'MinNull-RowBased imputation wrt whole data', marker='+', linestyle='-.', linewidth=2, markersize=12)
ax.plot(mean3, lw = 1, color = '#5be19a', alpha = 1, label = 'MinNull-RowBased imputation target first', marker='>', linestyle='-', linewidth=2, markersize=12)
ax.plot(mean4, lw = 1, color = '#ece554', alpha = 1, label = 'MinNull-RowBased imputation ref first', marker='s', linestyle='--', linewidth=2, markersize=12)
...
ax.fill_between(t, lb2, ub2, color = '#866bfa', alpha = 0.4)
