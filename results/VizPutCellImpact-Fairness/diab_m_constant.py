...
output_plot = 'diab_m_constant'



df1 = pd.read_csv('diab_m_constant/noimpute.csv')
df2 = pd.read_csv('diab_m_constant/pbci.csv') #PBCI
df3 = pd.read_csv('diab_m_constant/random_imputation.csv')
df4 = pd.read_csv('diab_m_constant/pbci_fairness.csv')
df5 = pd.read_csv('diab_m_constant/fairness.csv')
