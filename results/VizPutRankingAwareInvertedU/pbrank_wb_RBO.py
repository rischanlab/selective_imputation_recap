...
output_plot = 'pbrank_wb_rbo'



#df1 = pd.read_csv('pbrank_rbo/pbrank_wb1.csv')
df2 = pd.read_csv('pbrank_rbo/pbrank.csv') 
#df3 = pd.read_csv('pbrank_rbo/random.csv')
...
#ax.plot(mean1, lw = 1, color = '#b35410', alpha = 1, label = 'PBRank wb (constant-decrease)', marker='*', linestyle='-', linewidth=2, markersize=20)
ax.plot(mean2, lw = 1, color = '#5c4b51', alpha = 1, label = 'VizPut-Ranking-Aware-Baseline', marker='>', linestyle=':', linewidth=2, markersize=20)


#b35410 #marker='*', linestyle='-', linewidth=2, markersize=20)
