...
input_file1 = 'results/avg_dirty_impute_disease_vs_all.csv'
input_file2 = 'results/avg_dirty_impute_disease_vs_no.csv'
input_file3 = 'results/avg_dirty_impute_female_vs_male.csv'
#input_file4 = 'results/max_missing_vs_ideal.csv'
...
output_plot = 'cd_impact_incomplete_data'
...
ax.plot(mean1, lw = 1, color = '#fc7303', alpha = 1, label = 'Disease vs All', marker='x', linestyle=':', linewidth=2, markersize=20)
ax.plot(mean2, lw = 1, color = '#FF0000', alpha = 1, label = 'Disease vs NO disease', marker='<', linestyle='-.', linewidth=2, markersize=20)
ax.plot(mean3, lw = 1, color = '#008000', alpha = 1, label = 'Female vs Male', marker='o', linestyle='--', linewidth=2, markersize=20)
...
ax.set_ylabel("Effectiveness - dirty imputation")
