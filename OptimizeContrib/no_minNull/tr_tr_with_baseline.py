...
output_plot = 'tr_tr_with_baselines'
...
ax.plot(mean5, lw = 1, color = '#FF0000', alpha = 1, label = 'Bottom-up OptimizeContrib default setting', marker='<', linestyle='-.', linewidth=2, markersize=12)
ax.plot(mean4, lw = 1, color = '#0d948f', alpha = 1, label = 'Bottom-up OptimizeContrib $D_Q$ $D_R$ alternately', marker='*', linestyle=':', linewidth=2, markersize=12)
ax.plot(mean2, lw = 1, color = '#9c730e', alpha = 1, label = 'Bottom-up OptimizeContrib wrt whole data', marker='+', linestyle='-', linewidth=2, markersize=12)
