...
df5 = pd.read_csv('df5.csv') #max_chol
#df6 = pd.read_csv('df6.csv') #sum_chol

df7 = pd.read_csv('df7.csv') #count_chol
#df8 = pd.read_csv('df8.csv') #count_oldpeak
...
ax.plot(mean7, lw = 1, color = '#e32db0', alpha = 1, label = 'COUNT', marker='^', linestyle='-.', linewidth=2, markersize=20)

ax.plot(mean1, lw = 1, color = '#fc7303', alpha = 1, label = 'MAX', marker='x', linestyle=':', linewidth=2, markersize=20)


ax.plot(mean5, lw = 1, color = '#800000', alpha = 1, label = 'AVG', marker='*', linestyle='-', linewidth=2, markersize=20)

#ax.plot(mean2, lw = 1, color = '#FF0000', alpha = 1, label = 'disease_MAX_oldpeak', marker='<', linestyle='-.', linewidth=2, markersize=20)
ax.plot(mean3, lw = 1, color = '#008000', alpha = 1, label = 'SUM', marker='o', linestyle='--', linewidth=2, markersize=20)

#ax.plot(mean8, lw = 1, color = '#000000', alpha = 1, label = 'restchag_SUM_chol', marker='s', linestyle='--', linewidth=2, markersize=20)
#ax.plot(mean6, lw = 1, color = '#3e6980', alpha = 1, label = 'restecg_AVG_chol', marker='>', linestyle='-.', linewidth=2, markersize=20)
