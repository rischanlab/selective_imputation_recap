...
ax.plot(mean5, lw = 1, color = '#800000', alpha = 1, label = 'restecg_COUNT_*', marker='*', linestyle='-', linewidth=2, markersize=20)
...
ax.plot(mean7, lw = 1, color = '#e32db0', alpha = 1, label = 'restecg_MAX_chol', marker='^', linestyle='-.', linewidth=2, markersize=20)
