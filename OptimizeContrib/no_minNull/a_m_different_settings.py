...
output_plot = 'a_m_different_settings'
...
df4 = pd.read_csv('d44_1a.csv')
df5 = pd.read_csv('d44.csv')
...
ax.plot(mean2, lw = 1, color = '#FF0000', alpha = 1, label = 'Bottom-up OptimizeContrib |A|=|M|', marker='<', linestyle='-.', linewidth=2, markersize=12)
ax.plot(mean4, lw = 1, color = '#0000FF', alpha = 1, label = 'Bottom-up OptimizeContrib |A|=1 many |M|', marker='*', linestyle=':', linewidth=2, markersize=12)
ax.plot(mean5, lw = 1, color = '#d70ee6', alpha = 1, label = 'Bottom-up OptimizeContrib |A|<|M|', marker='+', linestyle='-', linewidth=2, markersize=12)
ax.plot(mean3, lw = 1, color = '#008000', alpha = 1, label = 'Bottom-up RandomImputation', marker='o', linestyle='--', linewidth=2, markersize=12)
ax.plot(mean1, lw = 1, color = '#000000', alpha = 1, label = 'No imputation', marker='x', linestyle=':', linewidth=2, markersize=12)
