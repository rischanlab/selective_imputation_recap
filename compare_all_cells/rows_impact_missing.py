...
dfj110 = df[(df['k'] == k) & (df['sample'] == 100)]
dfj110 = dfj110['Jaccard']

dfj120 = df[(df['k'] == k) & (df['sample'] == 150)]
dfj120 = dfj120['Jaccard']

dfj130 = df[(df['k'] == k) & (df['sample'] == 30)]
dfj130 = dfj130['Jaccard']

dfj140 = df[(df['k'] == k) & (df['sample'] == 40)]
dfj140 = dfj140['Jaccard']

dfj150 = df[(df['k'] == k) & (df['sample'] == 50)]
dfj150 = dfj150['Jaccard']

dfj160 = df[(df['k'] == k) & (df['sample'] == 60)]
dfj160 = dfj160['Jaccard']

dfj170 = df[(df['k'] == k) & (df['sample'] == 70)]
dfj170 = dfj170['Jaccard']

dfj180 = df[(df['k'] == k) & (df['sample'] == 80)]
dfj180 = dfj180['Jaccard']

dfj190 = df[(df['k'] == k) & (df['sample'] == 90)]
...
dfj210 = df[(df['k'] == k) & (df['sample'] == 100)]
dfj210 = dfj210['RBO']

dfj220 = df[(df['k'] == k) & (df['sample'] == 150)]
dfj220 = dfj220['RBO']

dfj230 = df[(df['k'] == k) & (df['sample'] == 30)]
dfj230 = dfj230['RBO']

dfj240 = df[(df['k'] == k) & (df['sample'] == 40)]
dfj240 = dfj240['RBO']

dfj250 = df[(df['k'] == k) & (df['sample'] == 50)]
dfj250 = dfj250['RBO']

dfj260 = df[(df['k'] == k) & (df['sample'] == 60)]
dfj260 = dfj260['RBO']

dfj270 = df[(df['k'] == k) & (df['sample'] == 70)]
dfj270 = dfj270['RBO']

dfj280 = df[(df['k'] == k) & (df['sample'] == 80)]
dfj280 = dfj280['RBO']

dfj290 = df[(df['k'] == k) & (df['sample'] == 90)]
dfj290 = dfj290['RBO']
...
df1 = pd.DataFrame([dfj130, dfj140, dfj150, dfj160, dfj170, dfj180, dfj190, dfj110, dfj120])
df1.columns = ['k','measurement','mean','lb','ub']
df2 = pd.DataFrame([ dfj230, dfj240, dfj250, dfj260, dfj270, dfj280, dfj290, dfj210, dfj220])
df2.columns = ['k','measurement','mean','lb','ub']
df3 = pd.DataFrame([dfj330, dfj340, dfj350, dfj360, dfj370, dfj380, dfj390, dfj310, dfj320])
...
x = [30, 40, 50, 60, 70, 80, 90, 100, 150]
xi = list(range(len(x)))
plt.xticks(xi, x)
# Display legend
