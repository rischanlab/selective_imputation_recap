...
ax.plot(mean2, lw = 1, color = '#b65332', alpha = 1, label = 'MinRowIncompleteData Impute', marker='<', linestyle='-', linewidth=2, markersize=12)
ax.plot(mean3, lw = 1, color = '#5be19a', alpha = 1, label = 'No Imputation', marker='o', linestyle='-', linewidth=2, markersize=12)
#ax.plot(mean4, lw = 1, color = '#ece554', alpha = 1, label = 'Bootstrap with linear extension', marker='s', linestyle='--', linewidth=2, markersize=12)
