...
output_plot = 'optimize_contrib_baselines'
...
ax.plot(mean2, lw = 1, color = '#FF0000', alpha = 1, label = 'Bottom-up OptimizeContrib', marker='<', linestyle='-.', linewidth=2, markersize=20)
#ax.plot(mean4, lw = 1, color = '#0000FF', alpha = 1, label = 'MinNull-RowBased imputation', marker='*', linestyle=':', linewidth=2, markersize=20)
ax.plot(mean3, lw = 1, color = '#008000', alpha = 1, label = 'Bottom-up RandomImputation', marker='o', linestyle='--', linewidth=2, markersize=20)
