...
output_plot = 'pbci_baselines_jaccard_vs_rbo'



df1 = pd.read_csv('pbci_jaccard/pbci_fairness.csv')
df2 = pd.read_csv('pbci_rbo/pbci_fairness.csv') #PBCI
#df3 = pd.read_csv('pbci_rbo/random.csv')
...
ax.plot(mean2, lw = 1, color = '#d94434', alpha = 1, label = 'VizPut-Cell-Impact-Fairness - RBO', marker='<', linestyle='-.', linewidth=2, markersize=20)
...
ax.plot(mean1, lw = 1, color = '#33168a', alpha = 1, label = 'VizPut-Cell-Impact-Fairness - Jaccard', marker='o', linestyle='--', linewidth=2, markersize=20)
