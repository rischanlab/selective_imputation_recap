...
output_plot = 'pbci_baselines_jaccard'



df1 = pd.read_csv('pbci_jaccard/noimpute.csv')
df2 = pd.read_csv('pbci_jaccard/pbci.csv') #PBCI
df3 = pd.read_csv('pbci_jaccard/random.csv')
df4 = pd.read_csv('pbci_jaccard/pbci_fairness.csv')
df5 = pd.read_csv('pbci_jaccard/fairness.csv')
