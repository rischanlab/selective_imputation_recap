...
for k in k_list:
    ...
    for i in mlist:
        for j in range(1):
            ...
            unique_dirty = get_unique(k, missing_topk)
            ...
            while cd != 1:
                ...
                for col in unique_col1:
                    ...
                    data[col] = df[col]
                imputed_missing_topk1 = generate_topk_views(k, data)
                sum_imputed_missing = get_utility_score_missing_topk(k, ideal_topk, imputed_missing_topk1)
                cd = cum_score(sum_imputed_missing, sum_ideal)
                print("CD result", cd)
