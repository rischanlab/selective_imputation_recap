...
input_file4 = 'results/count_oldpeak_distance.csv'


input_file5 = 'results/avg_chol_distance.csv'
input_file6 = 'results/max_chol_distance.csv'
input_file7 = 'results/sum_chol_distance.csv'
input_file8 = 'results/count_chol_distance.csv'




output_plot = 'distance_all_8'
...
ax.plot(mean1, lw = 1, color = '#fc7303', alpha = 1, label = 'cp_AVG_oldpeak', marker='x', linestyle=':', linewidth=2, markersize=20)
ax.plot(mean2, lw = 1, color = '#FF0000', alpha = 1, label = 'cp_MAX_oldpeak', marker='<', linestyle='-.', linewidth=2, markersize=20)
ax.plot(mean3, lw = 1, color = '#008000', alpha = 1, label = 'cp_SUM_oldpeak', marker='o', linestyle='--', linewidth=2, markersize=20)
ax.plot(mean4, lw = 1, color = '#000000', alpha = 1, label = 'cp_COUNT_*', marker='s', linestyle='--', linewidth=2, markersize=20)
ax.plot(mean5, lw = 1, color = '#0000FF', alpha = 1, label = 'fbs_AVG_chol', marker='+', linestyle=':', linewidth=2, markersize=20)
ax.plot(mean6, lw = 1, color = '#800000', alpha = 1, label = 'fbs_MAX_chol', marker='*', linestyle='-', linewidth=2, markersize=20)
ax.plot(mean7, lw = 1, color = '#3e6980', alpha = 1, label = 'fbs_SUM_chol', marker='>', linestyle='-.', linewidth=2, markersize=20)
ax.plot(mean8, lw = 1, color = '#e32db0', alpha = 1, label = 'fbs_COUNT_*', marker='^', linestyle='-.', linewidth=2, markersize=20)
