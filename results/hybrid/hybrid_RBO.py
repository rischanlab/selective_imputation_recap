...
output_plot = 'hybrid_rbo'



#df1 = pd.read_csv('hybrid/hybrid1.csv')
df2 = pd.read_csv('pbrank_rbo/pbrank.csv') 
df3 = pd.read_csv('hybrid/hybrid.csv')
df4 = pd.read_csv('pbrank_rbo/pbrank_u.csv')
df5 = pd.read_csv('pbci_fairness_rbo/pbci_fairness.csv')
...
ax.plot(mean3, lw = 1, color = '#806725', alpha = 1, label = 'Hybrid', marker='+', linestyle=':', linewidth=2, markersize=20)
#ax.plot(mean1, lw = 1, color = '#6a4fa8', alpha = 1, label = 'Hybrid 1', marker='x', linestyle='--', linewidth=2, markersize=20)
ax.plot(mean4, lw = 1, color = '#b31270', alpha = 1, label = 'VizPut-Ranking-Aware-Inverted-U',  marker='*', linestyle='--', linewidth=2, markersize=20)
ax.plot(mean2, lw = 1, color = '#5c4b51', alpha = 1, label = 'VizPut-Ranking-Aware-Baseline', marker='>', linestyle=':', linewidth=2, markersize=20)
ax.plot(mean5, lw = 1, color = '#0000FF', alpha = 1, label = 'VizPut-Cell-Impact-Fairness', marker='*', linestyle=':', linewidth=2, markersize=20)
